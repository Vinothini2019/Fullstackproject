...
export class RestaurantService {
 /* viewRestaurant(hotelId: number, restaurant: any) {
...
updateRestaurant(hotelId: number, restaurant: Restaurant): Observable<Object>{
  ...
  viewRestaurant(hotelId: number, restaurant: Restaurant): Observable<Object>{
    return this.httpClient.post(`${this.baseURL}/${hotelId}`, restaurant);
  }
